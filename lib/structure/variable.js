...
/**
 * Get the current super of this variable
 *
 * @author   Jelle De Loecker   <jelle@elevenways.be>
 * @since    0.1.0
 * @version  0.1.0
 *
 * @type     {Elevenways.Protodoc.Structure.Structure}
 */
Variable.linkValueProperty('super');

/**
 * The get method should also be from the value
 *
 * @author   Jelle De Loecker   <jelle@elevenways.be>
 * @since    0.1.0
 * @version  0.1.0
 ...
 * @type     {Elevenways.Protodoc.Structure.Structure}
 */
Variable.linkValueProperty('get');

/**
 * The has method should also be from the value
 *
 * @author   Jelle De Loecker   <jelle@elevenways.be>
 * @since    0.1.0
 * @version  0.1.0
 ...
 * @type     {Elevenways.Protodoc.Structure.Structure}
 */
Variable.linkValueProperty('has');
 ...
 */
Variable.setMethod(function getValue() {
	return this.value;
});
