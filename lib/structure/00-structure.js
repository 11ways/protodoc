/**
 * The Structure class is the basis for representations of things that
 * can hold multiple key-values, like function scopes, objects, ...
 *
...
Structure.setMethod(function get(name) {
	if (this.contents && this.contents.has(name)) {
...
Structure.setMethod(function assign(source, origin, create_version) {
	...
	if (source.contents) {
		this.contents = source.contents.clone();
	}
