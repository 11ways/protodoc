...
Node.setStatic(function setChildNodeProperty(name) {
	this.constitute(function addChildNodeProperty() {
		...
		if (this.child_node_properties.indexOf(name) == -1) {
...
/**
 * The overriden context (for calls & apply)
 *
 * @author   Jelle De Loecker   <jelle@elevenways.be>
 * @since    0.1.0
 * @version  0.1.0
 */
Node.setProperty('context_override', null);
 ...
 */
Node.setProperty(function context() {
...
Node.setMethod(function getContext() {
	...
	let context = this.runtime.getContext(this);
...
/**
 * Process with an overridden context
 *
 * @author   Jelle De Loecker   <jelle@elevenways.be>
 * @since    0.1.0
 * @version  0.1.0
 */
Node.setMethod(function processWithContext(context) {
	this.context_override = context;
	this.process();
	this.context_override = null;
});

/**
 * Process nodes that need to be hoisted
 * @TOOD: stop at new scopes!
 *
 * @author   Jelle De Loecker   <jelle@elevenways.be>
 * @since    0.1.0
 * @version  0.1.0
 */
Node.setMethod(function processHoist() {
...
Node.setMethod(function processNodes(nodes) {
	...
	// @TODO: this needs to be put somewhere more intelligent,
	//        and it should stop at new scope boundaries!
	this.processHoist();
...
Node.setMethod(function getNodeAt(position) {
	...
	if (arg_count == 1 && typeof position == 'number') {
		return this.getNodeAtIndex(position);
	}
 ...
 * @return   {Array}
 */
Node.setMethod(function getCompletionList(position) {
	...
	for (key in variables) {
		...
		structure = variables[key].at(position);
 ...
 * @version  0.1.0
 */
Node.setMethod(function registerError() {
