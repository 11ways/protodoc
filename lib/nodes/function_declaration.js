...
/**
 * Function declarations should be hoisted
 *
 * @author   Jelle De Loecker   <jelle@elevenways.be>
 * @since    0.1.0
 * @version  0.1.0
 ...
 * @type     {Boolean}
 */
FunctionDeclaration.setProperty('hoist', true);
...
FunctionDeclaration.setMethod(function process() {
	...
	let value = this.getResultStructure(),
	...
	variable.assign(value, this, false);

	owner.declare('function', this, name, variable);
});