 ...
 * @param    {String}   code
 *
 * @return   {Elevenways.Protodoc.Node.Program}
 */
Runtime.setMethod(function tokenize(code) {
...
Runtime.setMethod(function getContext(node) {
	...
	if (node && node.context_override) {
		return node.context_override;
	}
